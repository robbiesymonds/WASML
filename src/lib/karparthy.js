 ...
 * @type Class
 */
export const DQNAgent = function (env, opt) {
  this.gamma = getopt(opt, "gamma", 0.75) // future reward discount factor
  this.epsilon = getopt(opt, "epsilon", 0.1) // for epsilon-greedy policy
  this.alpha = getopt(opt, "alpha", 0.01) // value function learning rate
  ...
  this.experience_size = getopt(opt, "maxMemory", 5000) // size of experience replay
  this.learning_steps_per_iteration = getopt(opt, "episodeSize", 10)
